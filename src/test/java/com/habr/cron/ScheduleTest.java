...
public class ScheduleTest
{
    ...
    {
        return new Object[][] {
                {"*.*.* *:*:*.*",          "30.09.2021 12:00:00.002", // current date
                                           "30.09.2021 12:00:00.003", // expected date
                },

                // simple interval test
                {"*.*.* *:*:*.100-300",    "30.09.2021 12:00:00.002", // current date
                                           "30.09.2021 12:00:00.100", // expected date
                },
                {"*.*.* *:*:*.100-300",    "30.09.2021 12:00:00.100", // current date
                                           "30.09.2021 12:00:00.101", // expected date
                },
                // ranged interval test
                {"*.*.* *:*:*.100-300/3",  "30.09.2021 12:00:00.100", // current date
                                           "30.09.2021 12:00:00.103", // expected date
                },
                // constant test
                {"*.*.* *:*:*.100",        "30.09.2021 12:00:00.090", // current date
                                           "30.09.2021 12:00:00.100", // expected date
                },
                {"*.*.* *:*:*.100",        "30.09.2021 12:00:00.100", // current date
                                           "30.09.2021 12:00:01.100", // expected date
                },
    ...
    @Test(dataProvider = "nearestEvent_DataProvider")
    ...
    @DataProvider
    private Object[][] nearestEvent_DataProvider() throws ParseException
    {
        return new Object[][] {
                // simple interval test
                {"*.*.* *:*:*.100-300",    "30.09.2021 12:00:00.002", // current date
                ...
                {"*.*.* *:*:*.100-300/3",  "30.09.2021 12:00:00.101", // current date
                                           "30.09.2021 12:00:00.103", // expected date
                },
                // constant test
                {"*.*.* *:*:*.100",        "30.09.2021 12:00:00.090", // current date
                ...
                {"*.2.32 12:00:00", // schedule
                                            "31.03.2019 12:00:00.000", // current date
                                            "29.02.2020 12:00:00.000", // expected date
                },
                {"*.2.32 12:00:00", // schedule
                                            "31.03.2020 12:00:00.000", // current date
                ...
                // checking the step in 1 millisecond
                {"*.*.* *:*:*.*",          "30.09.2021 12:00:00.002", // current date
                                           "30.09.2021 12:00:00.002", // expected date
                },
                {"*.*.* * *:*:*.100", // schedule
                                            "01.01.2020 00:00:00.099", // current date
                                            "01.01.2020 00:00:00.100", // expected date
                ...
                {"2100.12.31 23:59:59.999", // schedule
                                            "01.01.2000 00:00:00.000", // current date
                                            "31.12.2100 23:59:59.999", // expected date
                },
                // overflow protection test of the day of the month (February, and others)
                {"*.*.29,30 12:00:00", // schedule
                                            "31.01.2021 12:00:00.000", // current date
                ...
                {"*.*.* *:*:*.*", // schedule
                                            "09.30.2021 12:00:00.002", // expected date
                                            "09.30.2021 12:00:00.002", // current date
                },
                {"*.4.6,7 * *:*:*.1,2,3-5,10-20/3", // schedule
                                            "01.01.2001 00:00:00.000", // expected date
                                            "06.04.2001 00:00:00.001", // current date
    ...
    @Test(dataProvider = "nearestPrevEvent_DataProvider")
    public void testNearestPrevEvent(String schedule, String sourceDate, String expectedDate) throws Exception
    {
        Schedule s = new Schedule(schedule);
        f.setTimeZone(TimeZone.getTimeZone("UTC"));
        Date date = f.parse(sourceDate);

        Date actual = s.NearestPrevEvent(date);
        Date expected = f.parse(expectedDate);
        assertEquals(actual, expected,
                "\n" +
                        f.format(expected) + " <- expected" +
    ...
    @DataProvider
    private Object[][] nearestPrevEvent_DataProvider()
    {
        return new Object[][] {
                // checking the correctness of processing intervals x-32 for days of the month
                {"*.*.20-32 12:00:00", // schedule
                ...
                {"*.*.* * *:*:*.*", // schedule
                        "01.01.2100 00:00:00.000",  // expected date
                        "01.01.2100 00:00:00.000",  // current date
                },
                {"*.*.* * *:*:*.*", // schedule
                        "01.01.2000 00:00:00.002",  // expected date
                        "01.01.2000 00:00:00.002", // current date
                },
                {"2000.12.31 23:00:00.999", // schedule
                        "31.12.2100 22:59:59.999", // expected date
                        "31.12.2000 23:00:00.999", // current date
                ...
                {"*.2.4,29,30 12:00:00", // schedule
                        "04.02.2022 12:00:00.000", // current date
                        "04.02.2022 12:00:00.000", // expected date
                },
                {"*.*.4,29,30 12:00:00", // schedule
                        "04.02.2021 12:00:00.000", // expected date
                        "04.02.2021 12:00:00.000", // current date
    ...
    private Object[][] nextEvent_WithOverflow() throws ParseException
    {
        return new Object[][] {
                ...
                {"2021.2.4,29,30 12:00:00", // schedule
                        "04.02.2021 12:00:00.000", // current date
                        "04.02.2022 12:00:00.000", // expected date - out of valid range (according schedule)
                },
        };
    }
    ...
    public void testGeneratorOnSmallRangeForMillisMustUseBitMap() throws Exception
    {
        ...
        Schedule schedule = new Schedule("*:*:*.100-101,150-151"); // was used ArrayMatcher
        ScheduleEventsGenerator generator = schedule.getEventsGenerator(start, true);

        for (int i = 0; i < 10000; i++)
        {
            generator.next(); // now we won't get ArrayIndexOutOfBoundsException
        }
    }

    @Test(dataProvider = "ArrayMatcherSpecial_DataProvider")
    public void testArrayMatcherSpecial(String schedule, String sourceDate, String expectedDate) throws Exception
    {
        Schedule s = new Schedule(schedule);
        f.setTimeZone(TimeZone.getTimeZone("UTC"));
        Date date = f.parse(sourceDate);
    ...
    @DataProvider
    private Object[][] ArrayMatcherSpecial_DataProvider()
    {
        return new Object[][] {
                {"*:*:*.900-920,940-963", // schedule
                        "01.01.2021 00:00:00.000", // current date
                        "01.01.2021 00:00:00.900", // expected date
                },
                {"*:*:*.900-920,940-963", // schedule
                        "01.01.2021 00:00:00.920", // current date
                        "01.01.2021 00:00:00.940", // expected date
                },
                {"*:*:*.900-920,940-963", // schedule
                        "01.01.2021 00:00:00.962", // current date
                        "01.01.2021 00:00:00.963", // expected date
                },
                {"*:*:*.900-920,940-963", // schedule
                        "01.01.2021 00:00:00.963", // current date
                        "01.01.2021 00:00:01.900", // expected date
                },
        };
    }
}
